...
function App() {
  ...
  if (mode === 'GATE_VIEW') {
    return <GateView onBack={() => setMode('LANDING')} myId={peerService.myId} sessionCode={joinId} />;
  }
          ...
          <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button
                    ...
                    className={`h-12 rounded-lg border font-bold text-sm transition hover:border-blue-500 focus:outline-none relative overflow-hidden ${deviceName === 'Start Gate'
                  ...
                  <button
                    onClick={() => setDeviceName('Split Gate')}
                    className={`h-12 rounded-lg border font-bold text-sm transition hover:border-yellow-500 focus:outline-none relative overflow-hidden ${deviceName === 'Split Gate'
                  ...
                  <button
                    ...
                    className={`h-12 rounded-lg border font-bold text-sm transition hover:border-purple-500 focus:outline-none relative overflow-hidden ${deviceName === 'Finish Gate'
              ...
              <div className="relative">
                ...
                <div className={`h-16 w-full bg-slate-900 border-2 rounded-xl flex items-center justify-center space-x-4 transition-colors ${joinId.length === 4 ? 'border-emerald-500' : 'border-slate-700'
                  }`}>
                  {[0, 1, 2, 3].map((i) => (
